		...
		$.ajax({
            ...
            success : function(jsonData){
                ...
                if( found == 0){
                	...
                	<div id="content"> <b>${query}</b> は見つかりませんでした。他の検索語で試してください。</div>
                ...
                $.each(facet_fields, function(i,facetField){
                	...
                	$.each(facetField.facetFieldArray, function(i,facetFieldArray){
                		...
                		<a data-query="${query}" data-fq="${lavel}:${nameStr}" class="facetField">${nameStr}(${countLong})</a><br />
                ...
                $.each(facet_queries, function(i,facetQuery){
                	...
                	$.each(facetQuery.facetCountLink, function(i,queryFieldArray){
                		...
                		<a data-query="${query}" data-fq="${pubStr}" class="facetQuery">${queryStr}(${countInt})</a><br />
                ...
                if(pcnt > 1){
                	...
                	if(cpag > 1){
                		...
                		<a data-query="${query} data-fq="${fq}" data-start=0 class="sentou">|&lt;&lt;先頭ページへ</a>&nbsp;&nbsp;&nbsp;
                		<a data-query="${query} data-fq="${fq}" data-start="${maeStart}" class="mae">&lt;前へ</a>&nbsp;&nbsp;&nbsp;
                	...
                	$.each(pages, function(i,page){
                		...
                		if(cpag == page){
                			...
                			$("#page").append(`<a data-query="${query} data-fq="${fq}" data-start="${pageStart}" class="pagination">${page}</a>&nbsp;&nbsp;&nbsp;`);
                	...
                	if(cpag < pcnt){
                		...
                		$("#page").append(`<a data-query="${query} data-fq="${fq}" data-start="${nextStart}" class="tugi">次へ&gt;</a>&nbsp;&nbsp;&nbsp;`);
                		$("#page").append(`<a data-query="${query} data-fq="${fq}" data-start="${matubiStart}" class="matubi">末尾ページへ&gt;&gt;|</a>&nbsp;&nbsp;&nbsp;`);
                	}
                }
              }
